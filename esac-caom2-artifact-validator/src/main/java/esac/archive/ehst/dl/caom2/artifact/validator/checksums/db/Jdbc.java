package esac.archive.ehst.dl.caom2.artifact.validator.checksums.db;
...
public class Jdbc {
    ...
    protected final static String DB_SCHEMA_PROP = "esac.tools.db.dbschema";
    ...
    protected Jdbc() throws PropertyVetoException, NumberFormatException {
        ...
        setDbschema(ConfigProperties.getInstance().getProperty(DB_SCHEMA_PROP));
        setDburl("jdbc:postgresql://" + getDbhost() + ":" + getDbport() + "/" + getDbname());
    ...
    private void setDbschema(String schema) {
        Jdbc.dbschema = schema;
    }
