package esac.archive.caom2.artifact.sync.hst;
 ...
 * 
 */
public class EhstArtifactStorage extends EsacAbstractArtifactStorage {
    ...
    private static final Logger log = Logger.getLogger(EhstArtifactStorage.class.getName());
    ...
    public EhstArtifactStorage() throws IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException,
