...
package esac.archive.ehst.dl.caom2.publications;
    ...
    public static void main(String[] args) {
        try {
            ...
            if (am.isSet("d") || am.isSet("debug")) {
                Log4jInit.setLevel("esac.archive.ehst.dl.caom2.publications", Level.DEBUG);
                ...
                Log4jInit.setLevel("esac.archive.ehst.dl.caom2.publications", Level.INFO);
